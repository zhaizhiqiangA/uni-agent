#!/usr/bin/env bash
# Megatron + fully-async training for the blackbox SWE-agent recipe.
#
# Uses GRPO + AgentFrameworkRolloutAdapter + SWEAgentFramework with Megatron backend.
# Designed for Qwen3.5 dense models (4B/9B).
#
# Usage:
...
echo "=== SWE-Agent Blackbox Megatron Training ==="
