"""Reward utilities for the blackbox mini-swe-agent recipe.

Self-contained; mirrors the claude-code reward module so mini_swe_agent/ does
not depend on claude_code/.
